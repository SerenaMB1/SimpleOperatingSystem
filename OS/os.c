...
/*Global that olds the check value*/
static volatile uint32_t mcheckValue = 0; 

uint32_t currentCheckValue(){
	return mcheckValue;
}
...
void _svc_OS_wait(_OS_SVC_StackFrame_t const * const stack, uint32_t checkCode){
